...
import { favoriteArticle } from '../../store/slice/ArticlesSlice'
...
const Article: React.FC<ArticleProps> = ({ article }) => {
  ...
  const handleLikeClick = () => {
    dispatch(favoriteArticle({ slug: article.slug, favorited: article.favorited }))
  }
  return (
      ...
      <div className={styles.infoWrapper}>
        <div className={styles.info}>
          <div className={styles.titleWrap}>
            <Link to={`/article/${article.slug}`} className={styles.title} onClick={() => window.scrollTo(0, 0)}>
              {article.title}
            </Link>
            <svg
              ...
              style={{ cursor: 'pointer', fill: article.favorited ? 'red' : 'black' }}
            >
              <g clipPath="url(#clip0_478_1295)">
                {article.favorited && (
                  <path
                    d="M7.99979 3.56936C7.26133 2.33859 6.03056 1.47705 4.55364 1.47705C2.46133 1.47705 0.861328 3.07705 0.861328 5.16936C0.861328 9.2309 3.07671 9.84628 7.99979 14.5232C12.9229 9.84628 15.1383 9.2309 15.1383 5.16936C15.1383 3.07705 13.5382 1.47705 11.4459 1.47705C9.96902 1.47705 8.73825 2.33859 7.99979 3.56936Z"
                    fill="#FF0707"
                  />
                )}
        ...
        <div className={styles.personInfo}>
          ...
          {article.author.image && <img src={article.author.image} alt="avatar" className={styles.img} />}
          {!article.author.image && <img src={unnamed} alt="avatar" className={styles.img} />}
        </div>
      </div>
